...
# }
#
# Situations can have up to two endings - one reached when progress reaches o (on_fail), the other when progress reaches 100 (on_progress_complete)
#
...
# PROGRESS BAR
# -----------------------
# Each Situation has a progress bar ranging from 1 to 100. 
# Progress can start from 0, 100, or somewhere in the middle.
#
...
# 		end = 40						# Where the stage ends and a new one starts. If using a single stage, end = 100
